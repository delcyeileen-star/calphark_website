      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="w-8 h-8 flex items-center justify-center">
              <img 
                ...
                alt="Calphark" 
                className="w-full h-full object-contain ai-float"
              />
            </div>
            <span className={`font-display tracking-tight transition-all duration-500 bg-clip-text text-transparent bg-gradient-to-r from-[#1E5BA8] via-[#7B3FF2] to-[#FF1E8E] ${isScrolled ? "text-lg" : "text-xl"}`}>Calphark</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              size="sm"
              className="rounded-full transition-all duration-500 bg-gradient-to-r from-[#1E5BA8] via-[#7B3FF2] to-[#FF1E8E] hover:shadow-lg hover:shadow-[#FF1E8E]/50 text-white px-6 h-9 text-xs font-semibold"
            >
              Get Started
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button 
              className="flex-1 bg-gradient-to-r from-[#1E5BA8] via-[#7B3FF2] to-[#FF1E8E] text-white rounded-full h-14 text-base hover:shadow-lg hover:shadow-[#FF1E8E]/50"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Get Started
            </Button>
