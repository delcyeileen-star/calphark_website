    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          <span className="inline-block hover:text-[#1E5BA8] transition-colors duration-300">Connect</span>
          <br />
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#FF1E8E] via-[#7B3FF2] to-[#1E5BA8] hover:scale-105 inline-block transition-transform duration-300">everything.</span>
        </h2>
      ...
      <div className={`relative left-1/2 -translate-x-1/2 w-screen -mt-16 transition-all duration-1000 delay-200 h-96 ${
        isVisible ? "opacity-100" : "opacity-0"
      }`}>
        <CorporateDataFlow />
      </div>
