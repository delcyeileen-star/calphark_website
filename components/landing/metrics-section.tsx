  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-sm font-mono text-muted-foreground">
                {mounted && time ? `${time.toLocaleTimeString("en-GB")} UTC` : "Loading..."}
              </span>
            </div>
        ...
        {/* Organic AI motion graph animation */}
        <div className={`w-full mb-0 transition-all duration-1000 delay-200 h-80 border border-[#7B3FF2]/20 rounded-lg overflow-hidden ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          <CorporateDataFlow />
        </div>
